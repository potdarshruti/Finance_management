<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="expensereport.aspx.cs" Inherits="Finance_management.expensereport" %>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row gutters">
                                ...
                                <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
                                   <div class="form-group">
                                       <asp:Button runat="server"  ID="btnIncome" OnClick="btnExpense_Click" Text="Submit" CssClass="btn btn-primary my-1" />
                                   </div>
                                </div>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ex_date" HeaderText="Date" DataFormatString="{0:dd/MM/yyyy}" />
                                    <asp:TemplateField HeaderText="Expense Date">
                                        <ItemTemplate>

                                            <asp:Label runat="server" Text='<%# Eval("ex_date")%>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Category">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label runat="server" Text='<%# Eval("ex_category")%>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Amount">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label runat="server" Text='<%# Eval("ex_amount")%>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Remark">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label runat="server" Text='<%# Eval("ex_remark")%>'></asp:Label>
