...
namespace Finance_management
{
    public partial class expensereport : System.Web.UI.Page
    {
        ...
        protected DataSet getdata()
        {
            ...
            con.Close();
            SqlCommand cmd = new SqlCommand("Select * from expense where ex_date BETWEEN @fromdate and @enddate and loginid=@id order by Srno", con);
            ...
            {
                total = total + Convert.ToDouble(dr["ex_amount"].ToString());
            }
